...
public sealed class BossEncounterRulesTests
{
    ...
    {
        Assert.True(BossEncounterRules.CanApplyWeaknessInsight(true, false, 50));
        Assert.False(BossEncounterRules.CanApplyWeaknessInsight(false, false, 50));
        Assert.False(BossEncounterRules.CanApplyWeaknessInsight(true, true, 50));
        Assert.False(BossEncounterRules.CanApplyWeaknessInsight(true, false, 40));
    }
