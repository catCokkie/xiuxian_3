...
> 目标：将装备系统从"仅副本掉落"扩展为与 11 个子系统全面联动，让每个子系统在装备成长链中都有明确作用，形成 Melvor 式的互联蛛网。
...
| **增益协同** | 该系统的产出/效果与装备属性加法叠加 | 体修永久HP、阵盘被动、灵膳Buff |
...
| 11 | **体修** | 增益协同 | 永久 HP/DEF +% 与护具属性叠加，是护具价值的放大器 | 无新增（体修本身即隐性装备层） |
